...
To change the character `'a'` to `'b'`, change the character `'a'` to `'c'` at a cost of 1, followed by changing the character `'c'` to `'b'` at a cost of 2, for a total cost of `1 + 2 = 3`.
